...
const toggleItemVisionImpaired =
  'vision-impaired:text-base vision-impaired:font-bold vision-impaired:text-white vision-impaired:hover:bg-gray-900 vision-impaired:data-[state=on]:bg-cyan-900 vision-impaired:data-[state=on]:text-white';
