...
const toggleRoot = cva(
  'inline-flex gap-1 rounded-lg bg-slate-900/50 p-0.5 w-full border border-slate-700/50'
);
const toggleRootVisionImpaired =
...
const toggleItemVisionImpaired =
  'vision-impaired:text-base vision-impaired:font-bold vision-impaired:text-white vision-impaired:hover:bg-gray-900 vision-impaired:data-[state=on]:bg-cyan-600 vision-impaired:data-[state=on]:text-white';
