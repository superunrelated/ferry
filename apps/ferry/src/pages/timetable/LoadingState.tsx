...
const spinner = cva('inline-block animate-spin rounded-full h-8 w-8 border-4 border-slate-600 border-t-cyan-400');
const spinnerVisionImpaired = 'vision-impaired:h-12 vision-impaired:w-12 vision-impaired:border-white vision-impaired:border-t-cyan-500 vision-impaired:border-4';
