...
const tableHeadVisionImpaired = 'vision-impaired:bg-black vision-impaired:border-b-2 vision-impaired:border-white';

const tableHeaderCell = cva('px-6 py-4 text-left text-xs font-bold text-slate-400 uppercase tracking-wider');
const tableHeaderCellVisionImpaired = 'vision-impaired:text-sm vision-impaired:text-white';
      ...
      <CardContent scrollable className="flex-1">
        <table className="w-full">
          <thead className={vi(tableHead(), tableHeadVisionImpaired)}>
            <tr>
              <th className={vi(tableHeaderCell(), tableHeaderCellVisionImpaired)}>
                Time
              </th>
              <th className={vi(tableHeaderCell(), tableHeaderCellVisionImpaired)}>
                Company
